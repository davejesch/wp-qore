...
<div class="wrap">
<div id="icon-options-general" class="icon32"><br></div><h2><?php _e( 'WP Qore Settings', 'wpqore' ); ?></h2>
...
<h3><?php _e( 'Login Settings', 'wpqore' ); ?></h3>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Customize login page', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( 'Change login page logo and link (Default is, WordPress)', 'wpqore' ); ?></i>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Login logo image url', 'wpqore' ); ?></label>
</th>
...
<br><?php _e( 'Type url of image for login page. Make sure it is approximately 320px width x 80px height.', 'wpqore' ); ?>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Conceal login page', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( "Turn 'On' to lock login page", 'wpqore' ); ?></i><br><br>
<?php _e( 'Once enabled, your example.com/wp-admin url will return a 404 error. The user who knows the secret key can access. For example, when example.com/wp-admin returns 404, example.com/wp-admin?secretkey1 will work. Remember, you can always change this secret key.', 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Login secret key', 'wpqore' ); ?></label> (<a target="_blank" href="<?php echo WP_PLUGIN_URL.'/'.basename( dirname( __FILE__ ) ).'/example/screenshot_01.png'; ?>" title="<?php _e( 'click to see example...', 'wpqore' ); ?>"><b>?</b></a>)</th>
<td>
 <input type="text" name="wpqorefunc_secret_arg" value="<?php echo get_option("wpqorefunc_secret_arg");?>" placeholder="<?php _ex( 'for url get parameter', 'placeholder text', 'wpqore' ); ?>">

<br><?php
printf(
	__('Only %s will work, otherwise, included default wp-admin address will return 404.', 'wpqore'),
	home_url().'/wp-admin?'. get_option("wpqorefunc_secret_arg") );
?><br>
	<br>
	<a href="javascript://" id="wpqorefunc_cr_exc_url"><?php _e( 'Add custom login page exception', 'wpqore' ); ?></a>
	<br>
<div id="wpqorefunc_cr_exc_div" style="display:none;margin-top:4px">
<?php _e( 'If you have custom login page (for example if you are using any community plugin such as Buddypress and your users log in to their profile via custom url such as <i>http://example.com/myloginpage</i> ) and you want that url continue working properly without wpqorefunc secret key, then just add that url to following input field.', 'wpqore' ); ?>
...
<?php _e( 'And then if you want to block your wp-admin for logged in <i>subscriber users</i>, check the following checkbox', 'wpqore' ); ?><br>
...
<i><?php _e( 'Block access to wp-admin for Logged in subscribers (all their requests will be redirected to homepage).', 'wpqore' ); ?></i></label> </div>
...
<h3><?php _e( 'Source Obfuscation', 'wpqore' ); ?></h3>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'New theme directory', 'wpqore' ); ?></label></th>
<td>
<input type="text" name="wpqorefunc_theme_directory" style="width:420px" value="<?php echo get_option("wpqorefunc_theme_directory");?>" placeholder="<?php _ex( 'theme directory', 'placeholder text', 'wpqore' ); ?>">
<br><?php 
printf(
	__( 'Create folder called <i>%s</i> in %s folder and then paste there any inactive theme folder you will need to use.', 'wpqore' ),
	get_option("wpqorefunc_theme_directory"),
	WP_CONTENT_DIR
);
?>	
<br><br>
<b><?php _e( 'Warning!', 'wpqore' ); ?></b>
<?php
printf( 
	__( "Don't cut/paste active theme from <i>themes</i> folder to <i>%s</i> folder. Do it only with inactive themes. First deactivate theme, cut & paste, then reactivate.", 'wpqore' ),
	get_option("wpqorefunc_theme_directory")
);
?>
</td>
...
<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Unique source code', 'wpqore' ); ?></label></th>
<td>
<?php
printf( 
...
<h3><?php _e( 'General Settings', 'wpqore' ); ?></h3>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Security advisor', 'wpqore' ); ?></label> (<a target="_blank" href="<?php echo WP_PLUGIN_URL.'/'.basename( dirname( __FILE__ ) ).'/example/screenshot_06.jpg'; ?>" title="<?php _e( 'click to see example...', 'wpqore' ); ?>"><b>?</b></a>)</th>
<td>
...
<i><?php _e( "Turn 'On' to enable (Recommended)", 'wpqore' ); ?></i><br><br>
<?php _e( "When checked, this will turn on Security Advisor. Security Advisor offers you protection from security threats, such as: virus, malicious code, and security exploits. Once enabled, a submenu labeled 'Security Advisor' will appear within the wp-admin > WP Qore > submenu. If you don't see it, then go to the dashboard first and it will initialize.", 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Replace dashboard', 'wpqore' ); ?></label> (<a target="_blank" href="<?php echo WP_PLUGIN_URL.'/'.basename( dirname( __FILE__ ) ).'/example/screenshot_04.png'; ?>" title="<?php _e( 'click to see example...', 'wpqore' ); ?>"><b>?</b></a>)</th>
<td>
...
<i><?php _e( "Turn 'On' to enable (Recommended)", 'wpqore' ); ?></i><br><br>
<?php _e( "When 'On', this will replace the standard wp-admin dashboard with a new one that is clean and lightweight.", 'wpqore' ); ?><br>
<input name="wpqorefunc_dash_tabs" type="checkbox" id="wpqorefunc_dash_tabs" value="1" <?php echo get_option("wpqorefunc_dash_tabs");?>> <i><?php _e( 'When checked, this will enable the WP Qore tabs on the new Dashboard.', 'wpqore' ); ?></i> (<a target="_blank" href="<?php echo WP_PLUGIN_URL.'/'.basename( dirname( __FILE__ ) ).'/example/screenshot_07.png'; ?>" title="<?php _e( 'click to see example...', 'wpqore' ); ?>"><b>?</b></a>)
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Nag updates', 'wpqore' ); ?></label> (<a target="_blank" href="<?php echo WP_PLUGIN_URL.'/'.basename( dirname( __FILE__ ) ).'/example/screenshot_05.png'; ?>" title="<?php _e( 'click to see example...', 'wpqore' ); ?>"><b>?</b></a>)</th>
<td>
...
<i><?php _e( "Turn 'On' to disable", 'wpqore' ); ?></i><br><br>
<?php _e( "This disables the annoying WordPress nag updates banner from appearing. This doesn't prevent updates, just conceals the update banner from the top of the wp-admin.", 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Core updates', 'wpqore' ); ?></label></th>
<td>
...
<b>Warning:</b> It is highly recommended that on your production environment you keep this option off. This option is provided for development environments only.', 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Post revisions', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( "Turn 'On' to disable", 'wpqore' ); ?></i><br><br>
<?php _e( 'This disables saving multiple post revisions. Having multiple post revisions could cause bloat on your database. Disabling them will prevent such.', 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Admin bar removal', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( 'Remove admin bar from the frontend', 'wpqore' ); ?></i>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Collapse admin menu', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( 'This keeps the wp-admin menu on the left collapsed.', 'wpqore' ); ?></i>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Change default jQuery', 'wpqore' ); ?></label></th>
<td>
...
<b>Attention:</b> If this doesn't play well with your theme, then simply turn it off.", 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Shortcode in widgets', 'wpqore' ); ?></label></th>
<td>
...
<?php _e( 'This enables shortcode in widgets. In the instance you need to use shortcode within your widgets, then enabling this will help you.', 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Php in widgets', 'wpqore' ); ?></label></th>
<td>
...
<b>Warning!</b> Turning this on may be a security risk. It's not recommended you use this unless you are very careful and know what you are doing. Use at your own risk.", 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Import/export widgets', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( "Turn 'On' to enable", 'wpqore' ); ?></i><br><br>
<?php _e( "This allows you to import and export your widget settings. Once enabled, a submenu labeled 'Export Widgets' and 'Import Widgets' will appear within the wp-admin > Tools menu.", 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Clean source code', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( 'Remove WP version from source code (Recommended)', 'wpqore' ); ?></i>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Cache assistance', 'wpqore' ); ?></label></th>
<td>
...
<b>Attention:</b> Do not enable this option if you have any other cache plugins enabled. This option simply enables the Cache Assistance module, but does not enable caching. In order to enable caching the frontend, you will need to turn it 'On' from the Cache Assistance options panel.", 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Minify your html', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( "Turn 'On' to enable", 'wpqore' ); ?></i><br><br>
<?php _e( 'This will minify the HTML of your source code. This makes your website load much faster and makes it harder for people to view the source code of your website.', 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Remove wp meta tags', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( "Turn 'On' to remove from source code", 'wpqore' ); ?></i><br><br>
<?php _e( 'Remove manifest, generator meta tags, adjacent posts rel links, parent post rel links, feed links, rsd link and index rel links from the source code.', 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top">
<th scope="row"><label for="home"><?php _e( 'Plugin/theme editor', 'wpqore' ); ?></label></th>
<td>
...
<i><?php _e( "Turn 'On' to disable", 'wpqore' ); ?></i><br><br>
<?php _e( 'This disables the theme and plugin editor from within WordPress. This is a good idea for production environments.', 'wpqore' ); ?>
</label>
</td>
</tr>

<tr valign="top" style="background-color:#373737" class="wpqorefunc_dbopt">
<th scope="row"><label for="home"><?php _e( 'Database audit', 'wpqore' ); ?></label></th>
<td>
<p>
<?php _e( 'This checks your Database and then gives you suggestions about security and making your website faster.', 'wpqore' ); ?>
<br> 
