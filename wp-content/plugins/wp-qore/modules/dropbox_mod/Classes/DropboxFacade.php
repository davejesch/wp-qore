 ...
 */
class WPQ2DBX_DropboxFacade{
    
    const CONSUMER_KEY = '4rsksp520p5wo85';
    const CONSUMER_SECRET = '4c8yox8agtaqipx';
    const RETRY_COUNT = 3;
    ...
    public function init()
    {
        ...
        if (!extension_loaded('curl')) {
            throw new Exception(sprintf(
                __('The cURL extension is not loaded. %sPlease ensure its installed and activated.%s', 'wp-qore'),
        ...
        $this->dropbox->setTracker(new WPQ2DBX_UploadTracker());
    }
    ...
    {
        if (preg_match('/-wpq2dbx-secret$/', $file))
