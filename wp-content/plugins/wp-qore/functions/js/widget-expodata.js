!function ($) {
	...
	$(function () {
		...
		widgetCheckboxes = $('.widget-expodata .widget-checkbox'),
		widgetSelectionError = $('.widget-expodata p.widget-selection-error');

		/**
		 * Handle click events for widget-expodata to select all checkboxes on click, to uncheck all
		 * checkboxes on click, and to activate the file upload when the file upload button is clicked.
		 * @param Object e Event object
		 */
		$('.widget-expodata').on('click', '.select-all, .unselect-all, .upload-button', function(e){
			e.preventDefault();
		 ...
		 * @param Object e Event object
		 */
		$('form#import-widget-expodata').submit(function(e){
			e.preventDefault();
			...
			$.post( ajaxurl, $("#import-widget-expodata").serialize(), function(r){
		...
		fileInput.change(function(){
			var outputText = $('#upload-widget-expodata .file-name'),
